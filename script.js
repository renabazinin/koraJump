// Game Configuration
const CONFIG = {
    gravity: 0.25, // Lower gravity for slower, floatier jump
    friction: 0.8,
    airFriction: 0.99,
    moveSpeed: 0.6, // Faster acceleration
    maxSpeed: 2.0, // Faster max speed
    jumpForce: -8.5, // Adjusted jump force for new gravity
    bounceForce: -6,
